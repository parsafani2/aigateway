  ...
  fa: {
    steps: {
      ...
      tutorial4: [
        ...
        "ارائه‌دهنده را انتخاب کنید (ChatGPT Browser یا Gemini Browser).",
        "مقدار توکن یا کوکی نشست را در فیلد توکن جای‌گذاری کنید.",
        "اختیاریاً User-Agent و آدرس IP را برای ضد تشخیص تنظیم کنید.",
        "اگر توکن تاریخ انقضا دارد، تاریخ انقضا را تنظیم کنید.",
        "از «چرخش» برای چرخش توکن‌های نشست و جلوگیری از تشخیص استفاده کنید.",
