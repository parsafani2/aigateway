...
| راهنمای شروع به کار | ۱۲ آموزش گام‌به‌گام از صفر تا صد، کاملاً دو‌زبانه با پیگیری پیشرفت |
...
│   │   ├── CostAnalysis.tsx       # تحلیل هزینه و بودجه
│   │   ├── Monitoring.tsx         # پایش پیشرفته و تشخیص ناهنجاری
│   │   ├── GettingStarted.tsx     # راهنمای شروع به کار (۱۲ آموزش دو‌زبانه)
...
│       └── 20260904143045_20260904150000_add_cost_tracking_and_anomaly_detection.sql.sql
├── index.html
├── package.json
├── tailwind.config.js
├── tsconfig.json
